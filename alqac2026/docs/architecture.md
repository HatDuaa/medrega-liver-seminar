...
2. `query_planner` tạo tối đa hai truy vấn cho mỗi vụ. `RetrievalClient` ưu tiên đọc cache; chỉ gọi mạng khi người chạy bật `--allow-network` rõ ràng.
...
4. Pipeline chọn bằng chứng vụ án, truy hồi điều luật bằng chỉ mục BM25 cục bộ và dự đoán nhãn.
...
Ở mốc Public đầu tiên, ledger có 50 attempt hoàn tất và 1 attempt nhận HTTP 429. Sau sự cố này, khoảng cách toàn cục 6 giây là cấu hình vận hành bắt buộc.
